...
return (
    <div className='min-h-screen flex flex-col md:flex-row'>
            ...
            {/*left side : Branding */}
            <div className='flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40 overflow-hidden min-h-0'>
                    <img src={assets.logo} alt="" className='h-12 object-contain' />
                    <div>
                            <div className='flex items-center gap-3 mb-4 max-md:mt-10'>
                                    <img src={assets.group_users} alt="" className='h-8 md:h-10 max-w-full'/>
                                    <div>
                                            <div className='flex'>
                            ...
                            <p className="text-xl md:text-3xl text-indigo-900 max-w-72 md:max-w-md">
                                Connect with global community on Creative Clan.
                            </p>
                    </div>

...
const CreatePost = () => {
  ...
  const handleSubmit = async () => {
    ...
    const postType = images.length && content ? 'text_with_image' : images.length ? 'iamge' : 'text'
    ...
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
        <div className="max-w-6xl mx-auto p-6">
          ...
          <div className="max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4">
            ...
            {/* Text Area */}
            <textarea className='w-full resize-none max-h-20 mt-4 text-sm outline-none placeholder-gray-400 shadow' placeholder="What's happening?" onChange={(e) => setContent(e.target.value)} value={content} />
             {/* Images */}
             {
             ...
             <div className="flex items-center justify-between pt-3 border-t border-gray-300">
              ...
              <button disabled={loading} onClick={()=> toast.promise(
                handleSubmit(), 
                {
                  ...
                  success: <p>Post Added Succussfully</p>,
